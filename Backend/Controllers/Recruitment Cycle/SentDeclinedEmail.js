...
<html lang="en" style="padding: '0px'; margin: '0px';">
  ...
  <body style="padding: '0px'; margin: '0px';">
    ...
    <footer class="" style="padding: '0px'; margin: '0px'; color: rgb(54, 124, 223); font-size: 1.5em; font-weight: bold; text-align: center; text-decoration: underline;">Powered By: ISC ATS</footer>
  </body>
</html>
